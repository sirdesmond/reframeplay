...
var make_chain = (function (p1__13017_SHARP_){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten(p1__13017_SHARP_));
});
...
var temp__4657__auto___13018 = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(re_frame.interceptor.interceptor_QMARK_,chain));
if(cljs.core.truth_(temp__4657__auto___13018)){
var not_i_13019 = temp__4657__auto___13018;
if(cljs.core.fn_QMARK_(not_i_13019)){
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$error,cljs.core.array_seq(["re-frame: when registering ",id,", got a function instead of an interceptor. Did you provide old style middleware by mistake? Got: ",not_i_13019], 0));
} else {
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$error,cljs.core.array_seq(["re-frame: when registering ",id,", expected interceptors, but got: ",not_i_13019], 0));
}
} else {
}
...
var _STAR_handling_STAR_13021 = re_frame.events._STAR_handling_STAR_;
re_frame.events._STAR_handling_STAR_ = event_v;

try{return re_frame.interceptor.execute(event_v,interceptors);
}finally {re_frame.events._STAR_handling_STAR_ = _STAR_handling_STAR_13021;
}}
} else {
return null;
}
