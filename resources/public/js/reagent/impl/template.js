...
var G__12762 = o;
(G__12762[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12764__i < G__12764__a.length) {G__12764__a[G__12764__i] = arguments[G__12764__i + 0]; ++G__12764__i;}
  args = new cljs.core.IndexedSeq(G__12764__a,0);
} 
...
var G__12770 = jsprops;
(G__12770["defaultValue"] = value);

(G__12770["onChange"] = ((function (G__12770,v,value,on_change){
return (function (p1__12768_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12768_SHARP_);
});})(G__12770,v,value,on_change))
);
...
var vec__12777 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12777,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12777,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12777,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12782 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12782 == null)){
} else {
var key_12783 = temp__4661__auto___12782;
(jsprops["key"] = key_12783);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12785 = (new reagent.impl.template.NativeWrapper());
(G__12785["name"] = c);
...
var G__12787 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12787) : reagent.impl.template.as_element.call(null,G__12787));
} else {
...
var len__7475__auto___12792 = arguments.length;
var i__7476__auto___12793 = (0);
while(true){
if((i__7476__auto___12793 < len__7475__auto___12792)){
args__7482__auto__.push((arguments[i__7476__auto___12793]));

var G__12794 = (i__7476__auto___12793 + (1));
i__7476__auto___12793 = G__12794;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7483__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12790){
var G__12791 = cljs.core.first(seq12790);
var seq12790__$1 = cljs.core.next(seq12790);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12791,seq12790__$1);
});
...
break;
default:
var G__12798 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12798;
continue;
...
var n__7319__auto___12801 = a.length;
var i_12802 = (0);
while(true){
if((i_12802 < n__7319__auto___12801)){
(a[i_12802] = reagent.impl.template.as_element((a[i_12802])));

var G__12803 = (i_12802 + (1));
i_12802 = G__12803;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7319__auto___12804 = a.length;
var i_12805 = (0);
while(true){
if((i_12805 < n__7319__auto___12804)){
var val_12806 = (a[i_12805]);
if((cljs.core.vector_QMARK_(val_12806)) && ((reagent.impl.template.key_from_vec(val_12806) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12805] = reagent.impl.template.as_element(val_12806));

var G__12807 = (i_12805 + (1));
i_12805 = G__12807;
continue;
} else {
}
...
var ctx = ({});
var vec__12811 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12811,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12811,(1),null);
...
var G__12815 = (cljs.core.count(argv) - first_child);
switch (G__12815) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12815){
